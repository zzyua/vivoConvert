...
import com.boot.security.service.SysCoreService;
...
public class AclControlFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        SysCoreService sysCoreService = SpringUtil.popBean(SysCoreService.class);
    ...
    private void noAuth(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (servletPath.endsWith(".json")) {
            Result jsonData = ResultUtil.error(ResultEnum.NOAUTHVIEW) ; //JsonData.fail("没有访问权限，如需要访问，请联系管理员");
