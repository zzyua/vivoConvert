...
import com.boot.entity.PageResult;
...
import com.boot.security.dto.SearchLogDto;
...
public class SysLogService {
        ...
        switch (sysLog.getType()){
            case LogType.TYPE_DEPT:
                ...
                if (StringUtils.isBlank(sysLog.getNewValue())  || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new RestDymaicException(ResultEnum.NOREDUCTIONFORADDANDDEL);
                }
    ...
    public PageResult<SysLogWithBLOBs> searchPageList(SearchLogParam param, PageQuery page) throws Exception{
        ...
        try {
            ...
            throw new RestDymaicException(ResultEnum.WRONGDATEFORMAT);
        }
